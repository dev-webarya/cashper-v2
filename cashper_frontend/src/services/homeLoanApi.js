...
const API_BASE_URL = 'http://127.0.0.1:8000/api/home-loan';
...
/**
 * Calculate EMI for Home Loan (PUBLIC - No login required)
...
/**
 * Submit Home Loan Application (PUBLIC - Works with or without login)
 * @param {object} applicationData - Full application data
 * @returns {Promise<object>} Response with application_id
 */
export const submitHomeLoanApplication = async (applicationData) => {
 ...
 * @param {string} applicationId - Application ID (e.g., HL-20251110-XXXXXX)

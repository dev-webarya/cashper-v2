...
/**
 * Calculate EMI for Personal Loan (PUBLIC - No login required)
...
/**
 * Submit Personal Loan Application (PUBLIC - Works with or without login)
 * @param {object} applicationData - Full application data
 * @returns {Promise<object>} Response with application_id
 */
export const submitPersonalLoanApplication = async (applicationData) => {
 ...
 * @param {string} applicationId - Application ID (e.g., PL-20251110-XXXXXX)
